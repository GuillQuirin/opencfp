...
namespace OpenCFP\Test\Unit\Http\Action\Reviewer\Talk;

use Localheinz\Test\Util\Helper;
use OpenCFP\Domain\Talk;
use OpenCFP\Http\Action\Reviewer\Talk\ViewAction;
...
final class ViewActionTest extends Framework\TestCase
{
    ...
    public function testRedirectsToDashboardIfTalkCannotBeViewed()
    {
        ...
        $urlGenerator
            ->generate(Argument::exact('reviewer_talks'))
            ->shouldBeCalled()
            ->willReturn($url);
    ...
    public function testRendersTalkIfTalkCanBeViewed()
    {
        ...
        $twig
            ->render(
                Argument::exact('reviewer/talks/view.twig'),
                Argument::exact(
                    [
