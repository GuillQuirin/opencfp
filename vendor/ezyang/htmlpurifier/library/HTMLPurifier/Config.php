...
class HTMLPurifier_Config
{
     ...
     *                                           object. Can be: a HTMLPurifier_Config()
     *                                           object, an array of directives based on
     *                                           loadArray(), or a string filename of an ini
     *                                           file.
     ...
     *                        called before it's been setup, otherwise won't
     *                        work.
     ...
     *                          or not to return null if the result is already
     *                          present in the cache.  This is off by default
     *                          for backwards compatibility reasons, but you
     *                          need to do things this way in order to ensure
     *                          that caching is done properly. Check out
     *                          enduser-customize.html for more details. We
     *                          probably won't ever change this default, as
     *                          much as the maybe semantics is the "right
     *                          thing to do."
     *
