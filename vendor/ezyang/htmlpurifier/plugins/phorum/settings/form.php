...
function phorum_htmlpurifier_show_form()
{
    ...
    $frm->addMessage(
        '<p>The box below sets <code>$PHORUM[\'mod_htmlpurifier\'][\'wysiwyg\']</code>.
    ...
    $frm->addMessage(
        '<p>The box below sets <code>$PHORUM[\'mod_htmlpurifier\'][\'suppress_message\']</code>,
    ...
    $frm->addMessage(
        '<p>Click on directive links to read what each option does
    ...
    include_once 'HTMLPurifier/Printer/ConfigForm.php';
