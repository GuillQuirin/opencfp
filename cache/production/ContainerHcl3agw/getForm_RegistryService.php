...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(
    array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(
        new \Symfony\Component\DependencyInjection\ServiceLocator(
            array('Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType' => function () {
        ...
        ), array('Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => new RewindableGenerator(
            function () {
        ...
        ), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\RepeatedType' => new RewindableGenerator(
            function () {
        ...
        ), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType' => new RewindableGenerator(
            function () {
            ...
            function () {
                ...
                yield 1 => ${($_ = isset($this->services['wouterj_eloquent.form.type_guesser']) ? $this->services['wouterj_eloquent.form.type_guesser'] : $this->services['wouterj_eloquent.form.type_guesser'] = new \WouterJ\EloquentBundle\Form\EloquentModelTypeGuesser()) && false ?: '_'};
            }, 2
        ), null
    )), ${($_ = isset($this->services['form.resolved_type_factory']) ? $this->services['form.resolved_type_factory'] : $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\ResolvedFormTypeFactory()) && false ?: '_'}
);
